...
var
	picture : image;			{ original image record }
        ...
        error1, a : boolean;			{ error checking variable }
...
begin
        ...
        for row := 1 to picture.height do begin
        	for column := 1 to picture.width do begin
                	if (row = picture.height) and (column = picture.width) then
                        ...
                        else if (row = 1) and (column = picture.width) then 
                        	mean.pixels[column,row] :=
                                	round((
                                        4*picture.pixels[column,row] +
                                        2*picture.pixels[column,row-1] +
                        ...
                        else if (row = picture.height) and (column = 1) then 
                        	mean.pixels[column,row] :=
                                	round((
                                        4*picture.pixels[column,row] +
                                        2*picture.pixels[column-1,row] +
                        ...
                        else if (row = 1) and (column = 1) then 
                        	mean.pixels[column,row] :=
                                	round((
                                        4*picture.pixels[column,row] +
                                        2*picture.pixels[column+1,row] +
                        ...
                        else if (column = picture.width) then 
                        	mean.pixels[column,row] :=
                                	round((
                                        picture.pixels[column-1,row-1] +
                        ...
                        else if (row = picture.height) then 
                        	mean.pixels[column,row] :=
                                	round((
                                        picture.pixels[column-1,row-1] +
                                        picture.pixels[column-1,row] +
